...
public class StorageConfig {
  ...
  public static final String DEFAULT_BUCKET_DOMAIN = CFG_OSS.getString("letter_bucket_domain");
  public static final String INTERNAL_ENDPOINT = CFG_OSS.getString("internal_endpoint");
}
